                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="font-family:'Open+Sans', 'Open Sans', Helvetica, Arial, sans-serif; font-size:13px; line-height:18px; color:#00C0EA; text-align:center; width:152px;">
                          ...
                          <tbody><tr>
                            <td style="padding:20px 0 10px 0;">
                              <a href="#tba" style="text-decoration:none;" target="_blank"><img alt="Sikil" border="0" height="100px" src="https://i.imgur.com/4O366QO.png" style="display:block; width:200px !important; font-family:'Open+Sans', 'Open Sans', Helvetica, Arial, sans-serif; font-size:22px; line-height:26px; color:#000000; text-transform:uppercase; text-align:center; letter-spacing:1px;" width="100%"></a>
                            </td>
                          </tr>
                                  ...
                                  <tbody><tr>
                                    <td>
                                      <p style="Margin:0; font-size:18px; line-height:23px; color:#102231; font-weight:bold;">
                                        <strong>
                                          Hi
                                          {{$user['first_name']}} {{$user['last_name']}},</strong><br><br>
                                      </p>
...
<tr>
	<td>
		 To complete your sign up, please verify your email: <br><br>
	</td>
</tr>
<tr>
